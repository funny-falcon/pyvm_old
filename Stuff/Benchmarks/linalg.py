# (c) 2005 Mladen Bestvina
#DEJAVU
'''
{
'NAME':"Linear Algebra",
'DESC':"Linear Algebra routines from Mladen Bestvina (shedskin unittests)",
'GROUP':'real-bench',
'CMPOUT':1,
'ARGS':"5",
'BARGS':"7"
...
def gen(n,list1,A,B,C,D,E,F):
    for i in range(n):
	iterate_sort(list1,A,B,C,D,E,F)
...
def main2():
    ...
    for t in reversed(range(1025)):
        if ttypes[t]>0:
            print t, binary(t), ttypes[t]
            break
            #print(' %03i   %012i   %i  ' %(t,binary(t),ttypes[t]))
