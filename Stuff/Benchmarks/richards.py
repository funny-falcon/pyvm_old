...
# Taken from pypy and modified for pyvmbench, Stelios Xanthakis
...
class Richards:
    ...
    def run(self):
		...
		print taskWorkArea.holdCount, taskWorkArea.qpktCount
                return False
...
def main_noargs():
    print "Richards benchmark starting... "
    ...
    print "\nTotal time for %d iterations: %d msecs" %(Richards.iterations, int(1000 * total_s))
    print "Average time for iterations: %d ms" % (int(total_s * 1000)/Richards.iterations)
    return 0

if __name__ == "__main__":
    times = int (sys.argv [1])
    Richards.iterations = times
    main_noargs ()
