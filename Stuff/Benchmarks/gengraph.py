...
{
'NAME':"gengraph",
'DESC':"""gengraph is a script by Jose Vasconcellos which
converts ncc output data to dot data.  Tested agains the source
callgraph of Quake for function main()!""",
'GROUP':'real-bench',
'CMPOUT':1,
'DATA':'DATA/Quake.map',
'ARGS':"DATA/Quake.map main",
'BARGS':"DATA/Quake.map main"
}
'''
...
if location:
    ...
    for s in start:
        ...
        print '"'+s+'" [ style="filled,bold", fillcolor="#dddddd", shape="box" ];'
