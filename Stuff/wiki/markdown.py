...
# modifications. Add a command line option -page which
# includes the generated HTML in <html><body> ... </body></html>
# using a standard css style
...
def cmd_line(args):
    ...
    if option == 'page':
        if 1:
            ...
            lucida, verdana, geneva, sans-serif; }
            body {margin: 0}
            body {background-color: #487ba6; padding: .2em; color: white; }
            .content { margin: 1em;}
            pre {background-color: #000000; color: orange; border: color: black;
                1px solid #aaa; padding: 1em; font-weight: bold;}
